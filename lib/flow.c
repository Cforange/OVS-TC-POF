...
flow_extract(struct dp_packet *packet, struct flow *flow)
{
    ...
    /*zq*/
    /*VLOG_INFO("+++++++++++zq flow_extract start");*/
    miniflow_extract(packet, &m.mf);
    miniflow_expand(&m.mf, flow);
    /*VLOG_INFO("+++++++++++zq flow_extract end");*/
}
...
{
    /*VLOG_INFO("+++++++++++zq pof_miniflow_extract start");*/
...
//        miniflow_push_pof_words(mf, pof_normal, data, 14);
    ...
    out:
    dst->map = mf.map;
    /*VLOG_INFO("+++++++++++zq pof_miniflow_extract end");*/
}
void
...
{
    /*VLOG_INFO("+++++++++++zq pof_miniflow_expand: before memset");*/
    memset(dst, 0, sizeof *dst);
    pof_flow_union_with_miniflow(dst, src);
    /*VLOG_INFO("+++++++++++zq pof_miniflow_expand: after pof_flow_union_with_miniflow");*/
}
